...
class File(BaseModel):
    ...
    def compute_documents(self, loader_class):
        ...
        Args: loader_class (class): The class of the loader to use to load the file
        """
        ...
        # print("TYPE:", type(self.documents))
        # print("Lenght:", len(self.documents))
        # print("DOC:", self.documents)
        # for doc in self.documents:
        #    doc.page_content = "Represent the document for retrieval; Input: " + doc.page_content
